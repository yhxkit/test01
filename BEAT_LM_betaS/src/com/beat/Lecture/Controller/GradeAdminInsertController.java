...
public class GradeAdminInsertController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		// 목록 - 입력 페이지로 이동
		req.getRequestDispatcher("/administration/student_grade_add.jsp").forward(req, resp);
...
/*		long pointAvr = Long.parseLong(req.getParameter("pointAvr"));
		...
		gradeAdminDao.gradeInsert(mnum, javaPoint, webPoint, DBPoint);
		
		resp.sendRedirect("/BEAT_LMS/grade_view.lms");
	}
