...
//	public void gradeInsert(int mnum, int lectSeriNum, int javaPoint, int webPoint, int DBPoint){
	public void gradeInsert(int mnum, int javaPoint, int webPoint, int DBPoint){
		String sql="insert into "
				+ "Class_grade(point_SeriNum, mnum, lectSeriNum, "
				+ "javapoint, webpoint, dbpoint) "
				+ "values(gradeSeri_sq.nextVal, ?, (select lectSeriNum from lmsMember where mnum=?), "
				+ "?, ?, ?)";
